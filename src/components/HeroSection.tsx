        ...
        <div className="flex flex-col items-center justify-center max-w-4xl mx-auto">
          <div className="animate-fade-in">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight">
              Transform Your Business With Our <span className="bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">NXTGEN Solution</span>
            </h1>
            
            <p className="text-lg md:text-xl mb-8 text-gray-300 max-w-2xl mx-auto">
              Crafting powerful web and mobile applications alongside stunning graphic designs that elevate digital experiences and strengthen brand identity.
            </p>
            ...
            <div className="mt-4">
              <p className="text-sm text-gray-300">
                <span className="font-semibold text-saas-orange">Transforming</span> ideas into powerful digital solutions.
              </p>
              </div>
            </div>
            </div>
